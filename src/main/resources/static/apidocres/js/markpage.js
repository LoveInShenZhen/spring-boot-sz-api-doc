...
var ResConfig = {
    ...
    marx_css: '/apidocres/css/marx.min.css',
    mermaid_css: '/apidocres/css/mermaid.min.css',
    ...
    zepto_js: '/apidocres/js/zepto.min.js',
    showdown_js: '/apidocres/js/showdown.min.js',
    highlight_js: '/apidocres/js/highlight.min.js',
    mermaid_js: '/apidocres/js/mermaid.min.js'
};
(function () {
    function markpage() {
        var self = this;
        ...
        this.render = function (selector) {
            ...
            self.loadcss('/apidocres/css/railscasts.min.css');
